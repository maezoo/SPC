...
// // //     console.log(newsBtn, magazineBtn, snsBtn);  // 여기서 버튼들이 제대로 선택되는지 확인
// // // });
...
// // 추가된 부분: 슬라이드 클릭 이벤트
// const slides = document.querySelectorAll('.swiper-slide'); // 슬라이드 선택
...
//         console.log('Slide hovered:', this);
//         // 호버 시 수행할 작업 추가
//     });
// });
...
//     console.log(newsBtn, magazineBtn, snsBtn);
// });
